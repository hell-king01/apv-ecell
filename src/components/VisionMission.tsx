          ...
          <div className={`transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <div className="glass-card p-8 rounded-xl h-full hover:translate-y-[-5px] transition-all duration-300 group">
              <div className="flex items-center mb-6">
                <div className="p-3 rounded-full bg-[#2F0654]/10 border border-[#2F0654]/30 group-hover:border-[#2F0654]/60 transition-colors duration-300">
                  <svg className="w-8 h-8 text-[#2F0654]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-4 text-gray-300">
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 rounded-full bg-[#2F0654] mt-2 flex-shrink-0"></div>
