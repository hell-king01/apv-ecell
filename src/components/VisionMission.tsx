          ...
          <div className={`transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <div className="glass-card p-8 rounded-2xl h-full group">
              <div className="flex items-center mb-8">
                ...
                <h3 className="text-3xl font-bold text-white font-['Space_Grotesk']">Our Vision</h3>
              </div>
              ...
              <div className="space-y-6 text-[#CCCCCC]">
                <div className="flex items-start space-x-4 group/item">
                  ...
                  <p className="text-lg group-hover/item:text-white transition-colors duration-300">
                    Creating a global ecosystem of student entrepreneurs who drive meaningful change
                  </p>
                </div>
                <div className="flex items-start space-x-4 group/item">
                  <div className="w-3 h-3 rounded-full bg-[#A259FF] mt-2 flex-shrink-0 group-hover/item:shadow-[0_0_10px_rgba(162,89,255,0.7)] transition-shadow duration-300"></div>
                  <p className="text-lg group-hover/item:text-white transition-colors duration-300">
                    Bridging the gap between academic knowledge and real-world innovation
                  </p>
                </div>
                <div className="flex items-start space-x-4 group/item">
                  <div className="w-3 h-3 rounded-full bg-[#A259FF] mt-2 flex-shrink-0 group-hover/item:shadow-[0_0_10px_rgba(162,89,255,0.7)] transition-shadow duration-300"></div>
                  <p className="text-lg group-hover/item:text-white transition-colors duration-300">
                    Establishing our institution as a leading hub for entrepreneurial excellence
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className={`transform transition-all duration-1000 delay-200 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <div className="glass-card p-8 rounded-2xl h-full group">
              <div className="flex items-center mb-8">
                ...
                <h3 className="text-3xl font-bold text-white font-['Space_Grotesk']">Our Mission</h3>
              </div>
              ...
              <div className="space-y-6 text-[#CCCCCC]">
                <div className="flex items-start space-x-4 group/item">
                  ...
                  <p className="text-lg group-hover/item:text-white transition-colors duration-300">
                    Nurture innovative thinking through workshops, mentorship, and practical exposure
                  </p>
                </div>
                <div className="flex items-start space-x-4 group/item">
                  <div className="w-3 h-3 rounded-full bg-[#872ff7] mt-2 flex-shrink-0 group-hover/item:shadow-[0_0_10px_rgba(135,47,247,0.7)] transition-shadow duration-300"></div>
                  <p className="text-lg group-hover/item:text-white transition-colors duration-300">
                    Connect students with industry leaders, investors, and successful entrepreneurs
                  </p>
                </div>
                <div className="flex items-start space-x-4 group/item">
                  <div className="w-3 h-3 rounded-full bg-[#872ff7] mt-2 flex-shrink-0 group-hover/item:shadow-[0_0_10px_rgba(135,47,247,0.7)] transition-shadow duration-300"></div>
                  <p className="text-lg group-hover/item:text-white transition-colors duration-300">
                    Provide resources and support for transforming ideas into viable businesses
                  </p>
                </div>
              </div>
            </div>
