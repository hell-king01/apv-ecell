              ...
              {[...achievements, ...achievements].map((achievement, index) => (
                ...
                >
                  <div className="glass-card p-6 rounded-xl text-center min-w-[250px] hover:scale-105 transition-all duration-300">
                    <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-[#00CFFF]/20 to-[#00CFFF]/40 flex items-center justify-center border border-[#00CFFF]/30 group-hover:border-[#00CFFF] transition-colors duration-300">
                      <div className="w-8 h-8 bg-gradient-to-br from-[#00CFFF] to-[#0099cc] rounded-full"></div>
                    </div>
                    <h3 className="text-white font-bold mb-2 group-hover:text-[#00CFFF] transition-colors duration-300">
                      {achievement.name}
                    </h3>
        ...
        <div className="mt-16 text-center">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className={`transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <div className="text-3xl md:text-4xl font-bold text-[#00CFFF] mb-2">200+</div>
              <div className="text-gray-300">Startups Launched</div>
            </div>
            <div className={`transform transition-all duration-1000 delay-400 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <div className="text-3xl md:text-4xl font-bold text-[#00CFFF] mb-2">₹50Cr+</div>
              <div className="text-gray-300">Funding Raised</div>
            </div>
            <div className={`transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <div className="text-3xl md:text-4xl font-bold text-[#00CFFF] mb-2">5000+</div>
              <div className="text-gray-300">Students Mentored</div>
            </div>
            <div className={`transform transition-all duration-1000 delay-600 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <div className="text-3xl md:text-4xl font-bold text-[#00CFFF] mb-2">25+</div>
